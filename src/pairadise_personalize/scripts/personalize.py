...
def main(args): 
  ...
  helpStr = "--------------------------------------------- \n"+\
            ...
            " $pairadise2 personalize [OPTIONS] -r reference -v vcf -o outdir \n" \
  ...
  if len(command)>1:
    if command[1].strip().lower() == "help" :
      ...
      sys.exit()
  if not args.r:
    sys.stderr.write("ERROR: pairadise2  personalize command requires -r parameter \nExample: pairadise2 personalize -v vcf_directory -r reference.fa  -o pairadise2 \n")
    sys.exit()
  if not args.v:
    sys.stderr.write("ERROR: pairadise2  personalize command requires -v parameter \nExample: pairadise2 personalize -v vcf_directory -r reference.fa  -o pairadise2 \n")
    sys.exit()
  if not args.o:
    sys.stderr.write("ERROR: pairadise2  personalize command requires -o parameter \nExample: pairadise2 personalize -v vcf -r reference.fa -o pairadise2 \n")
    sys.exit()
